...
const capabilities = [
  ...
  },
  {
    ...
    title: 'RFID',
    desc: 'Implantación de sistemas RFID para control de inventario, acceso y trazabilidad en tiempo real a lo largo de toda la cadena.',
  ...
  },
  {
    ...
    title: 'Trazabilidad',
    desc: 'Control total del ciclo de vida del producto, desde la recepción hasta la entrega, con visibilidad completa en cada punto.',
  ...
  },
  {
    ...
    desc: 'Integración de procesos operativos mediante soluciones de captura de datos y automatización para reducir errores y tiempos.',
  ...
  },
  {
    ...
    desc: 'Mantenimiento preventivo, soporte técnico, formación especializada y gestión integral del ciclo de vida del dispositivo.',
    tag: 'Servicio 360°',
  },
]
    ...
    <section id="soluciones" style={{ padding: '120px 40px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '72px' }}>
        ...
        <h2 style={{ fontSize: 'clamp(32px, 4vw, 52px)', fontWeight: 800, maxWidth: '600px', lineHeight: 1.1 }}>
          ...
          <span style={{ color: 'var(--accent)' }}>punto crítico</span>{' '}
          de tu operativa
        </h2>
      </div>
        ...
        {capabilities.map((cap, i) => (
          ...
          >
            ...
            <div style={{
              ...
              background: hovered === i ? 'var(--accent-dim)' : 'rgba(255,255,255,0.04)',
              border: `1px solid ${hovered === i ? 'rgba(0,212,255,0.2)' : 'var(--border)'}`,
              borderRadius: '12px',
            ...
            <div style={{
              fontFamily: 'var(--font-syne)', fontSize: '11px', fontWeight: 600,
            ...
            <h3 style={{ fontFamily: 'var(--font-syne)', fontSize: '20px', fontWeight: 700, marginBottom: '12px' }}>
              {cap.title}
            </h3>

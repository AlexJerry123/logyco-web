...
const cases = [
  {
    sector: 'Logística',
    company: 'Operador Logístico Nacional',
    ...
    results: [
      { metric: '99.8%', label: 'precisión en picking' },
      { metric: '-68%', label: 'tiempo de inventario' },
      { metric: '3x', label: 'velocidad de expedición' },
    ],
    color: '#00d4ff',
  },
  {
    ...
    results: [
      { metric: '+22%', label: 'OEE productivo' },
      { metric: '100%', label: 'trazabilidad lote' },
      { metric: '-40%', label: 'tiempo de reporte' },
    ],
    color: '#0066ff',
  },
  {
    sector: 'Healthcare',
    company: 'Red Hospitalaria Regional',
    ...
    results: [
      { metric: '-85%', label: 'tiempo localización' },
      { metric: '+30%', label: 'utilización de activos' },
      { metric: '12 meses', label: 'retorno inversión' },
    ],
    color: '#10b981',
  },
]
    ...
    <section id="casos" style={{ padding: '120px 40px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '64px' }}>
        ...
        <h2 style={{ fontSize: 'clamp(32px, 4vw, 52px)', fontWeight: 800, maxWidth: '600px', lineHeight: 1.1 }}>
          Resultados reales,{' '}
          <span style={{ color: 'var(--accent)' }}>transformación</span>{' '}
          demostrada
        </h2>
      </div>
      ...
      <div style={{
        ...
        <div style={{ padding: '56px', background: 'var(--card)' }}>
          <div style={{
            ...
            <span style={{ fontFamily: 'var(--font-syne)', fontSize: '11px', fontWeight: 600, color: c.color, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              {c.sector}
            </span>
          </div>

          <h3 style={{ fontFamily: 'var(--font-syne)', fontSize: '22px', fontWeight: 700, marginBottom: '32px' }}>
            {c.company}
          </h3>

          <div style={{ marginBottom: '24px' }}>
            <div style={{ fontFamily: 'var(--font-syne)', fontSize: '11px', fontWeight: 600, color: 'var(--text-muted)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '8px' }}>
              Reto
            </div>
            <p style={{ fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.7, fontWeight: 300 }}>
              {c.challenge}
            </p>
          </div>
        ...
        <div style={{
          padding: '56px',
          background: `radial-gradient(ellipse at 30% 50%, ${c.color}12 0%, var(--surface) 70%)`,
          display: 'flex', flexDirection: 'column', justifyContent: 'center',
        }}>
          <div style={{ fontFamily: 'var(--font-syne)', fontSize: '11px', fontWeight: 600, color: 'var(--text-muted)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '40px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            {c.results.map((r, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                <div style={{
                  fontFamily: 'var(--font-syne)', fontSize: '40px', fontWeight: 800,
                  color: c.color, lineHeight: 1, minWidth: '120px',
                }}>
                  {r.metric}
                </div>
                <div style={{
                ...
                <div style={{ fontSize: '14px', color: 'var(--text-secondary)', fontWeight: 300 }}>
                  {r.label}
                </div>
              </div>
            ))}

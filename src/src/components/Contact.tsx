        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '80px 20px' }}>
          <div className="contact-grid">
            <div>
              ...
              {[{ l: 'Ubicación', v: 'Barcelona, España' }, { l: 'Teléfono', v: '+34 93 XXX XX XX' }, { l: 'Email', v: 'info@logisticacodificacion.es' }].map(item => (
            ...
            <div style={{ background: 'white', borderRadius: '16px', padding: '32px' }}>
              {sent ? (
                ...
                <form onSubmit={e => { e.preventDefault(); setSent(true) }} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                  ...
                  <button type="submit" style={{ padding: '14px', background: 'var(--navy)', border: 'none', borderRadius: '8px', fontFamily: 'var(--font)', fontSize: '14px', fontWeight: 600, color: 'white', cursor: 'pointer', transition: 'background 0.2s' }}
